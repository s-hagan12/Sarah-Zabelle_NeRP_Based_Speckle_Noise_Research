        ...
        for it, (grid, image) in enumerate(data_loader):
            ...
            for iterations in range(max_iter):
                ...
                if iterations == 0 or (iterations + 1) % config['val_iter'] == 0:
                    ...
                    print("[Validation Iteration: {}/{}] Test loss: {:.4g} | Test psnr: {:.4g} | Test ssim: {:.4g}".format(iterations + 1, max_iter, test_loss, test_psnr, test_ssim), file=f)
